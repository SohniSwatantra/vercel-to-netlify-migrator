    ...
    >
      {socials.map((social, index) => (
        <a
          ...
          className={cn(
            "relative cursor-pointer px-2 py-1 transition-opacity duration-200",
        ...
        >
          <span className="block text-sm font-normal text-gray-700 hover:text-gray-900">{social.name}</span>
          <AnimatePresence>
